"""
Enterprise MLOps Pipeline — Test Suite: Model Training
=======================================================
...
class TestBuildModel:
    ...
    def test_params_applied(self):
        from src.train import build_model
        params = {"n_estimators": 25, "max_depth": 7, "min_samples_split": 4,
                  "min_samples_leaf": 2, "max_features": "sqrt", "n_jobs": -1, "random_state": 99}
