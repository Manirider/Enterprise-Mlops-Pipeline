...
def sample_raw_df() -> pd.DataFrame:
    return pd.DataFrame({'age': [39, 50, 38, 53, None], 'workclass': [' State-gov', ' Self-emp-not-inc', ' Private', ' Private', ' ?'], 'fnlwgt': [77516, 83311, 215646, 234721, 100000], 'education': [' Bachelors', ' Bachelors', ' HS-grad', ' 11th', ' Bachelors'], 'education_num': [13, 13, 9, 7, 13], 'marital_status': [' Never-married', ' Married-civ-spouse', ' Divorced', ' Married-civ-spouse', ' Never-married'], 'occupation': [' Adm-clerical', ' Exec-managerial', ' Handlers-cleaners', ' Handlers-cleaners', ' ?'], 'relationship': [' Not-in-family', ' Husband', ' Not-in-family', ' Husband', ' Not-in-family'], 'race': [' White', ' White', ' White', ' Black', ' White'], 'sex': [' Male', ' Male', ' Male', ' Male', ' Female'], 'capital_gain': [2174, 0, 0, 0, 0], 'capital_loss': [0, 0, 0, 0, 0], 'hours_per_week': [40, 13, 40, 40, 40], 'native_country': [' United-States'] * 5, 'income': [' <=50K', ' <=50K', ' <=50K', ' >50K', ' >50K.']})
...
class TestLoadRawData:
    ...
    def test_loads_csv_without_header(self, tmp_path: Path) -> None:
        ...
        csv_content = '39, State-gov, 77516, Bachelors, 13, Never-married, Adm-clerical, Not-in-family, White, Male, 2174, 0, 40, United-States, <=50K\n'
